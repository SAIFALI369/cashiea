  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="max-w-lg w-full card p-5 text-center">
        <div className="w-16 h-16 rounded-xl bg-warning/15 border border-warning/30 flex items-center justify-center mx-auto mb-5">
          <AlertTriangle className="w-8 h-8 text-warning" />
        </div>
        <div className="flex items-center justify-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-accent to-accent-strong flex items-center justify-center">
