...
export default function AppLayout() {
  ...
  const hideBottomNav = ['/app/khata', '/app/accounts', '/app/promotions', '/app/reports', '/app/invoices', '/app/profit-dashboard', '/app/gst-export', '/app/tally-export'].includes(location.pathname)
  const goBack = () => {
