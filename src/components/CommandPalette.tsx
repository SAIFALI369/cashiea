...
const COMMANDS: Command[] = [
  ...
  { label: 'Meraj tasks', hint: 'AI task queue & approvals', icon: ListChecks, to: '/app/brain', keywords: 'brain tasks ai quick approvals' },
  { label: 'Campaigns', hint: 'WhatsApp & email campaigns', icon: MessageCircle, to: '/app/campaigns', keywords: 'campaigns marketing whatsapp email blast' },
  { label: 'Meraj plan', hint: "Meraj's one-tap action plan", icon: ClipboardCheck, to: '/app/manifest', keywords: 'manifest plan actions one-tap' },
  { label: 'Job monitor', hint: 'Background job failures', icon: AlertTriangle, to: '/app/failed-jobs', keywords: 'failed jobs errors background queue' },
