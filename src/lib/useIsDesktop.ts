...
/**
 * useIsDesktop — tracks whether the viewport is at the desktop breakpoint (md, ≥768px).
 * Used so we can render the desktop shell (top header + desktop shell + full-screen Meraj)
