...
const results = [
  ...
  { icon: TrendingUp, value: '+27%', label: 'repeat customers', color: 'text-accent' },
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <nav className="border-b border-line/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-accent to-accent-strong flex items-center justify-center">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <span className="inline-block px-3 py-1 rounded-full bg-accent-strong/15 text-accent-strong text-xs font-semibold mb-4">CASE STUDY</span>
        ...
        <div className="card p-5 mb-12 bg-gradient-to-br from-accent-strong/30 to-transparent">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent to-accent-strong flex items-center justify-center text-white font-bold">M</div>
            <div>
        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-12">
          <div className="card p-4">
            <h2 className="font-bold text-white mb-4 text-negative">Before</h2>
            <ul className="space-y-3">
              {before.map((b) => (
                <li key={b} className="flex items-start gap-2 text-sm text-slate-400"><span className="text-negative mt-0.5">✕</span> {b}</li>
              ))}
            </ul>
          </div>
          <div className="card p-4 border-accent-strong/40">
            <h2 className="font-bold text-white mb-4 text-positive">After</h2>
            <ul className="space-y-3">
              {after.map((a) => (
                <li key={a} className="flex items-start gap-2 text-sm text-slate-300"><Check className="w-4 h-4 text-positive mt-0.5 flex-shrink-0" /> {a}</li>
              ))}
            </ul>
          </div>
        </div>
        ...
        <div className="card p-6 text-center bg-gradient-to-br from-accent-strong/30 to-transparent">
